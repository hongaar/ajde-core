...
abstract class Component extends Standard
{
	const AC_XMLNS = 'ac';
	const AV_XMLNS = 'av';
	 ...
	 */
	public function __construct(Parser $parser, $attributes, $innerXml = null)
	{
	 ...
	 */
	public static function fromNode(Parser $parser, DOMNode $node)
	{

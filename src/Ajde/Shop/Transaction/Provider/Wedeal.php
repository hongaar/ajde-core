...
class Wedeal extends Provider
{
	...
	public function getRedirectUrl($description = null)
    {
		...
		$request = array(			
			...
			"transactionreq" => array(
				...
				"description"	=> Config::get('ident') . ': ' . String::makePlural($transaction->shipment_itemsqty, 'item'),
	...
	public function updatePayment() {
		...
		if ($username != Config::get('shopWedealCallbackUsername')) { Log::log('Invalid username for callback of transaction ' . $secret); return false; }
		if ($password != Config::get('shopWedealCallbackPassword')) { Log::log('Invalid password for callback of transaction ' . $secret); return false; }

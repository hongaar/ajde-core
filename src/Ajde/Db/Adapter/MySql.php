...
use Ajde\Db\Adapter\AbstractAdapter;
use PDO;
use Ajde\Db;
...
class MySql extends AbstractAdapter
{
	...
	public static function getFieldType($type) {
		...
		$types = array(
			Db::FIELD_TYPE_NUMERIC => "tinyint smallint mediumint int bigint decimal float double real bit boolean serial",
			Db::FIELD_TYPE_TEXT => "char varchar tinytext mediumtext text longtext binary varbinary tinyblob mediumblob blob longblob",
			Db::FIELD_TYPE_DATE => "date datetime timestamp time year",
			Db::FIELD_TYPE_ENUM => "enum set",
			Db::FIELD_TYPE_SPATIAL => "geometry point linestring polygon multipoint multilinestring multipolygon geometrycollection"
        );

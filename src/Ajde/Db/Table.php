...
class Table extends Standard
{
	...
	{
		$structure = Db::getInstance()->getAdapter()->getTableStructure($this->_name);
		foreach($structure as $field) {
			$fieldName				= $field['Field'];
			$fieldType				= $field['Type'];
			$fieldParsedType		= Db::getInstance()->getAdapter()->getFieldType($fieldType);			
	...
	public function getFK($column) {
		$fk = Db::getInstance()->getAdapter()->getForeignKey((string) $this, (string) $column);

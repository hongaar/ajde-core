...
{	
	...
	public function getCookieHash($includeDomain = true)
	{
		...
		if (!in_array('sha256', hash_algos())) {
			// TODO:
			throw new Exception('SHA-256 algorithm not available for hashing');
		}
		...
		if (empty($hash)) {
			// TODO:
			throw new Exception('SHA-256 algorithm failed');
		}
		return $hash;
	}
	...
	{
		// @todo exception
		throw new Exception('Please implement sendResetMail in UserModel');
		return false;
	}

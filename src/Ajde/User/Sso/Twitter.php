...
class Twitter extends Sso
{
    ...
    public function getMe()
    {
        ...
        throw new Exception('Provider Facebook has no authenticated user');
    ...
    public function getAuthenticationURL($returnto = '')
    {
        ...
        switch ($connection->http_code) {
            ...
            default:
                ...
                throw new Exception('Could not connect to Twitter (' . $connection->http_info . '). Refresh the page or try again later.');
        }
    }

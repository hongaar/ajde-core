...
class Xhtml extends Parser
{
	...
	public function parse()
	{
		...
		try {
			...
			// TODO:
			//return false;
			throw new Exception('Xhtml Parser error: ' . $e->getMessage());
		}
		...
		$this->_acNS = $root->lookupNamespaceURI(Component::AC_XMLNS);
		$this->_avNS = $root->lookupNamespaceURI(Component::AV_XMLNS);

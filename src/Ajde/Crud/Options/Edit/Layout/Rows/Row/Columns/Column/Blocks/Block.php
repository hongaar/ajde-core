...
namespace Ajde\Crud\Options\Edit\Layout\Rows\Row\Columns\Column\Blocks;

use Ajde\Crud\Options;



class Block extends Options
{		
	/**
	 *
	 ...
	 * @return Ajde_Crud_Options_Edit_Layout_Rows_Row_Columns_Column_Blocks_Block
	 */
	public function setTitle($title)	{ return $this->_set('title', $title); }
	 ...
	 * @return Ajde_Crud_Options_Edit_Layout_Rows_Row_Columns_Column_Blocks_Block
	 */
	public function setClass($cssClass)	{ return $this->_set('class', $cssClass); }
}